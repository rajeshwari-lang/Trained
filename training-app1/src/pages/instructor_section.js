...
export default function InstructorSection(props){
    return (
                ...
                <li>
                  <div className="space-y-4">
                    <div className="aspect-w-3 aspect-h-2">
                      <img className="object-cover shadow-lg rounded-lg" src="https://images.unsplash.com/photo-1505840717430-882ce147ef2d?ixlib=rb-1.2.1&ixqx=UgujetFY6E&ixid=eyJhcHBfaWQiOjEyMDd9&auto=format&fit=facearea&facepad=8&w=1024&h=1024&q=80" alt="" />
                    </div>
                    <div className="text-lg leading-6 font-medium space-y-1">
                      <h3>Java</h3>
                      <p className="text-indigo-600">Java and React will stack</p>
                    </div>
